...
public interface CustomerRepository extends JpaRepository<Customer, Integer>{
	...
	public default List<Customer> findAll(Pagination pagination) {
		...
		case 1: page = this.findByLastNameOrFirstNameContaining(searchText, searchText, pageable);  break;
		case 2: page = this.findByJobTitleContaining(searchText, pageable);  break;
		case 3: page = this.findByCityStartingWith(searchText, pageable);  break;
	...
	public Page<Customer> findByLastNameOrFirstNameContaining(String lastName, String firstName,  Pageable pageable);
	public Page<Customer> findByJobTitleContaining(String jobtitle, Pageable pageable);
	public Page<Customer> findByCityStartingWith(String city, Pageable pageable);
}
